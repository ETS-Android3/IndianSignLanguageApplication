...
import com.rc.islrecognition.MainActivity;
import com.rc.islrecognition.R;
...
public class LiveISLRecognitionActivity extends com.rc.islrecognition.AbstractCameraXActivity<LiveISLRecognitionActivity.AnalysisResult> {
    private Module mModule = null;
    private TextView mResultView;

    private final static int DELETE = 26;
    private final static int NOTHING = 27;
    private final static int SPACE = 26;
    ...
    protected int getContentViewLayoutId() {
        return R.layout.activity_live_isl_recognition;
    }

    @Override
    protected TextureView getCameraPreviewTextureView() {
        mResultView = findViewById(R.id.resultView);
        return ((ViewStub) findViewById(R.id.isl_recognition_texture_view_stub))
                .inflate()
    ...
    protected AnalysisResult analyzeImage(ImageProxy image, int rotationDegrees) {
        if (mModule == null) {
            try {
                /** Change assetName: (Model Torchscript for a better model) */
