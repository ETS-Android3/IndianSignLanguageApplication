...
public abstract class AbstractCameraXActivity<R> extends com.rc.islrecognition.BaseModuleActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_CAMERA_PERMISSION) {
            if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
                Toast.makeText(
                        this,
                        "You can't use live Module without granting CAMERA permission",
                        Toast.LENGTH_LONG
                ).show();
                finish();
            } else {
